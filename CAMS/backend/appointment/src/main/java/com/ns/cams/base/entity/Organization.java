...
public class Organization {
	 ...
	 */
	public int getPasswordExpiryNotifyDays() {
	 ...
	 */
	public void setPasswordExpiryNotifyDays(int passwordExpiryNotifyDays) {
	...
	/**
	 * @param orgStartDate the orgStartDate to set
	 */
